...
export default function ProfilePage(props) {
  ...
  return (
    <div>
      <AppBar />
      <Parallax small filter image="https://comp30002.blob.core.windows.net/image/career.jpg" />
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.profile}>
                  <div>
                    <img src="https://comp30002.blob.core.windows.net/image/profile.png" alt="..." className={imageClasses} />
                  </div>
