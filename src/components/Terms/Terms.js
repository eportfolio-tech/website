    ...
    return (
        <Layout>
            ...
            <h1 style={{textAlign: 'center', color: 'green'}}>
                <strong>FORTY-TWO TERMS AND CONDITIONS</strong>
            </h1>
            <p>&nbsp;</p>
            <h2>
            ...
            <p>
                ...
                full.&nbsp;&nbsp; If you disagree with these terms and
            ...
            <p>
                Unless otherwise stated, Forty-Two and/or its licensors own the
                intellectual property rights in the website and material on the
                website.&nbsp; Subject to the license below, all these
                intellectual property rights are reserved. You may view,
                download for caching purposes only, and print from the website
                for your own personal use, subject to the restrictions set out
            ...
            <p>
                ...
                website without Forty-Two&rsquo;s express written consent.
            </p>
            <p>&nbsp;</p>
            <h2>
            ...
            <p>
                ...
                Forty-Two reserves the right to restrict access to other areas
                of this website, or indeed this entire website, at
                Forty-Two&rsquo;s discretion.
            </p>
            <p>
                If Forty-Two provides you with a user ID and password to enable
            ...
            <p>
                Forty-Two may disable your user ID and password in
                Forty-Two&rsquo;s sole discretion without notice or explanation.
            </p>
            <p>&nbsp;</p>
            <h2>
            ...
            <p>
                In these terms and conditions, &ldquo;your user content&rdquo;
            ...
            <p>
                You grant to Forty-Two a worldwide, irrevocable, non-exclusive,
                royalty-free license to use, reproduce, adapt, publish,
                translate and distribute your user content in any existing or
                future media.&nbsp; You also grant to Forty-Two the right to
            ...
            <p>
                ...
                of giving rise to legal action whether against you or Forty-Two
                or a third party (in each case under any applicable
                law).&nbsp;&nbsp;
            </p>
            <p>
            ...
            <p>
                Forty-Two reserves the right to edit or remove any material
                submitted to this website, or stored on Forty-Two&rsquo;s
                servers, or hosted or published upon this website.
            </p>
            <p>
                Notwithstanding Forty-Two&rsquo;s rights under these terms and
                conditions in relation to user content, Forty-Two does not
            ...
            <p>
                This website is provided &ldquo;as is&rdquo; without any
                representations or warranties, express or implied.&nbsp;
                Forty-Two makes no representations or warranties in relation to
                this website or the information and materials provided on this
                website.&nbsp;
            </p>
            <p>
                Without prejudice to the generality of the foregoing paragraph,
                Forty-Two does not warrant that:
            </p>
            <ul>
                <li>
            ...
            <p>
                Forty-Two will not be liable to you (whether under the law of
            ...
            <p>
                These limitations of liability apply even if Forty-Two has been
            ...
            <p>
                ...
                limit Forty-Two&rsquo;s liability in respect of any:
            </p>
            <ul>
                <li>
                    death or personal injury caused by Forty-Two&rsquo;s
                    negligence;
                </li>
                <li>
                ...
                <li>
                    matter which it would be illegal or unlawful for Forty-Two
            ...
            <p>
                You accept that, as a limited liability entity, Forty-Two has an
                interest in limiting the personal liability of its officers and
                employees.&nbsp; You agree that you will not bring any claim
                personally against Forty-Two&rsquo;s officers or employees in
            ...
            <p>
                ...
                disclaimer will protect Forty-Two&rsquo;s officers, employees,
            ...
            <p>
                You hereby indemnify Forty-Two and undertake to keep Forty-Two
                indemnified against any losses, damages, costs, liabilities and
                expenses (including without limitation legal expenses and any
                amounts paid by Forty-Two to a third party in settlement of a
                claim or dispute on the advice of Forty-Two&rsquo;s legal
                advisers) incurred or suffered by Forty-Two arising out of any
            ...
            <p>
                Without prejudice to Forty-Two&rsquo;s other rights under these
                terms and conditions, if you breach these terms and conditions
                in any way, Forty-Two may take such action as Forty-Two deems
            ...
            <p>
                Forty-Two may revise these terms and conditions from
                time-to-time.&nbsp; Revised terms and conditions will apply to
                the use of this website from the date of the publication of the
            ...
            <p>
                Forty-Two may transfer, sub-contract or otherwise deal with
                Forty-Two&rsquo;s rights and/or obligations under these terms
            ...
            <p>
                ...
                unenforceable, the other provisions will continue in
                effect.&nbsp; If any unlawful and/or unenforceable provision
